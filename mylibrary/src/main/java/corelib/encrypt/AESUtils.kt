...
object AESUtils {
    ...
    private val CBC_METHOD = "AES/CBC/PKCS5Padding"
    private val CHARSET = Charsets.UTF_8

    val secretKey = "hnmSQari6hZSh3x3aXJDAXKwMXukLbSe"

    /**
     * 簡易的な暗号化。暗号化したBase64の文字列を返す
     */
    fun encryptByAES(src: String?, secretKey: String): String? {
    ...
    /**
     * `encryptByAES`で暗号化したデータを復号化する
     */
    fun decryptByAES(encodedBase64: String?, secretKey: String): String? {
